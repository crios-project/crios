		  ...
		  case 'Teala':
			 switch(right) {
				 ...
				 case 'Kali':
				   ...
				   break;
				 case 'Pyara':
				   relate = 'Teala thinks of Pyara as her oasis. Later, Pyara\'s death is a source of guilt for her.';
				   $('#result').html(relate);
				   break;
				 case 'Mahana':
		  ...
		  case 'Eshelia':
			 switch(right) {
				 ...
				 case 'Riasa':
				   ...
				   break;
				 case 'Daeon':
				   relate = 'Eshelia was instumental in the vast majority of the hardships Daeon has experienced in life. They don\'t get along.';
				   $('#result').html(relate);
				   break;
				 case 'Marate':
		  ...
		  case 'Kali':
			 switch(right) {
				 case 'Teala':
				   ...
				   break;
				 case 'Eshelia':
				   relate = 'Kali thinks Eshelia is dependable. Later, she hates herself for ever thinking Eshelia was trustworthy.';
				   $('#result').html(relate);
				   break;
				 case 'Kwele':
				 ...
				 case 'Kali':
				   ...
				   break;
				 case 'Pyara':
				   relate = 'Pyara is Kali\'s entire world. After they lost their parents, Kali grew up fast to take care of her sister.';
				   $('#result').html(relate);
				   break;
				 case 'Mahana':
				 ...
				 case 'Itami':
				   ...
				   break;
				 case 'Shini':
				   relate = 'Odisse thinks Shini is using her power to control Mahana. She\'s tried to quietly assassinate Shini more than one. ';
				   $('#result').html(relate);
				   break;
				 case 'Wentea':
				 ...
				 case 'Riasa':
				   ...
				   break;
				 case 'Daeon':
				   relate = 'Odisse reluctantly trusts Daeon.';
				   $('#result').html(relate);
				   break;
				 case 'Marate':
				 ...
				 case 'F&uacute; c&igrave;':
				   ...
				   break;
				 case 'Amaranthine':
				   relate = 'Odisse and Amaranthine have a very tense relationship. She wonders if killing Amy will hurt Teala.';
				   $('#result').html(relate);
				   break;
				 default:
				   relate = '';
		  ...
		  case 'Pyara':
			 switch(right) {
				 case 'Teala':
				   ...
				   break;
				 case 'Eshelia':
				   relate = 'Pyara think Eshelia is the most beautiful girl she\'s ever seen. She really wants to kidnap Eshelia and use her as a dress up doll.';
				   $('#result').html(relate);
				   break;
				 case 'Kwele':
				   ...
				   break;
				 case 'Kali':
				   relate = 'Pyara loves her sister, but she finds her completely overbearing.';
				   $('#result').html(relate);
				   break;
				 case 'Pyara':
				   relate = 'She rather likes herself.';
				 ...
				 case 'Kayre':
				   ...
				   break;
				 case 'Riasa':
				   relate = 'Pyara finds Riasa a threat, though she doesn\'t show it.';
				   $('#result').html(relate);
				   break;
				 case 'Daeon':
				   relate = 'They\'ve never met.';
		  ...
		  case 'Mahana':
			 switch(right) {
				 ...
				 case 'Kayre':
				   ...
				   break;
				 case 'Riasa':
				   relate = 'Mahana has no conflict with Riasa, however as Riasa is a friend of Kwele\'s, Mahana tries to force info about Shini from her.';
				   $('#result').html(relate);
				   break;
				 case 'Daeon':
		  ...
		  case 'Rayen':
			 switch(right) {
				 ...
				 case 'Eshelia':
				   ...
				   break;
				 case 'Kwele':
				   relate = 'Rayen finds Kwele frustrating. Kwele tends to do things on her whimsy and a logical person like Rayen can\'t understand her.';
				   $('#result').html(relate);
				   break;
				 case 'Kali':
				   ...
				   break;
				 case 'Pyara':
				   relate = 'Rayen\'s biggest goal in life is to catch Pyara and make her work. It\'s a constant battle.';
				   $('#result').html(relate);
				   break;
				 case 'Mahana':
				   relate = 'After what happened to Pyara, Rayen is especially nice to Mahana. Mahana doesn\'t realize that Rayen is treating her particularly well.';
				   $('#result').html(relate);
				   break;
				 case 'Rayen':
				   relate = 'She rather likes herself.';
